...
__all__ = ['ResNet50', 'ResNet101', 'DenseNet121']
...
class AlignedResNet101(nn.Module):
    def __init__(self, num_classes, loss={'softmax'}, aligned=False, **kwargs):
        super(AlignedResNet101, self).__init__()
        self.loss = loss
...
class AlignedDenseNet121(nn.Module):
    def __init__(self, num_classes, loss={'softmax'}, aligned=False,**kwargs):
        super(AlignedDenseNet121, self).__init__()
        self.loss = loss
